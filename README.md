...
[`docs/concours.md`](docs/concours.md) is what nine agents established about the
...
[`docs/echelle.md`](docs/echelle.md) is a cost pass rather than a defect pass:
...
[`docs/audits/premier.md`](docs/audits/premier.md) is the first: a full defect
...
are covered in [docs/deploiement.md](docs/deploiement.md).
