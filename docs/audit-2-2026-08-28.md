...
**État au début :** 755 tests. **À la fin :** 771, dont 16 nouveaux couvrant ce
qui a été trouvé.
...
### 4. Du code défensif que rien ne pouvait atteindre
...
### Tests de mutation — huit garanties récentes
...
### L'histoire d'un élément peut être incomplète sans le dire

Le journal est borné à 200 entrées. Passé cette limite, l'histoire d'une règle
ancienne s'appauvrit **en silence** — alors que `what_changed` annonce
explicitement son élagage. Un test constate le fait sans le corriger.

Le correctif honnête serait de dire « des entrées plus anciennes ont été
écartées » quand un `audit_trimmed` précède la plus ancienne entrée retenue.
Laissé de côté : il faudrait le poser dans le rendu de la ligne, et la fenêtre
avant le concours est courte.
