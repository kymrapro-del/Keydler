...
| 2   | Agent calls `create_task` unprompted        | Edge 152 + bridge, and ChatGPT built-in / Terra | static     | **FAIL** | Tools registered and visible in both. Neither looked at the page unprompted |
