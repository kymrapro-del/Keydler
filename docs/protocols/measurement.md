...
[`resumption.md`](../protocols/resumption.md).
...
[`measurements/results.md`](../measurements/results.md). A later campaign will have to
...
[`measurements/results.md`](../measurements/results.md).
